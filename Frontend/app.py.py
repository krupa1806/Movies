...
# CONFIG
# =============================
# API_BASE now reads from an environment variable first (set this on
# Streamlit Cloud under "Secrets" or "Advanced settings -> Environment
# variables"). Falls back to your deployed Render URL if not set.
